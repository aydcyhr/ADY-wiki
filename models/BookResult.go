...
import (
	...
	"github.com/aydcyhr/ADY-wiki/conf"
	"github.com/aydcyhr/ADY-wiki/converter"
	"github.com/aydcyhr/ADY-wiki/utils/filetil"
	"github.com/aydcyhr/ADY-wiki/utils/ziptil"
	"gopkg.in/russross/blackfriday.v2"
	"regexp"
	"github.com/aydcyhr/ADY-wiki/utils/cryptil"
	"github.com/aydcyhr/ADY-wiki/utils/requests"
	"github.com/aydcyhr/ADY-wiki/utils/gopool"
	"net/http"
	"encoding/json"
)
...
func (m *BookResult) Converter(sessionId string) (ConvertBookResult, error) {
	...
	ebookConfig := converter.Config{
		...
		Footer:       "<p style='color:#8E8E8E;font-size:12px;'>本文档使用 <a href='https://github.com/aydcyhr' style='text-decoration:none;color:#1abc9c;font-weight:bold;'>ADY-wiki</a> 构建 <span style='float:right'>- _PAGENUM_ -</span></p>",
