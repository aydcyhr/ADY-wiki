...
import (
	...
	"github.com/aydcyhr/gocaptcha"
	"github.com/aydcyhr/ADY-wiki/cache"
	"github.com/aydcyhr/ADY-wiki/conf"
	"github.com/aydcyhr/ADY-wiki/models"
...
func ResolveCommand(args []string) {
	flagSet := flag.NewFlagSet("ADY-wiki command: ", flag.ExitOnError)
	flagSet.StringVar(&conf.ConfigurationFile, "config", "", "ADY-wiki configuration file.")
	flagSet.StringVar(&conf.WorkingDirectory, "dir", "", "ADY-wiki working directory.")
	flagSet.StringVar(&conf.LogFile, "log", "", "ADY-wiki log file path.")
