...
- [Markdown 语法说明（简体中文）](https://github.com/aydcyhrmarkdown-basic.md "Markdown 语法说明（简体中文）")
...
[https://github.com/aydcyhrflowchart.md](https://github.com/aydcyhrflowchart.md)

##### 时序图参考 (SequenceDiagram reference)

[https://github.com/aydcyhrsequence.md](https://github.com/aydcyhrsequence.md)

#### 基于 mermaid 的甘特图、时序图以及流程图

<https://github.com/aydcyhrmermaid.md>
