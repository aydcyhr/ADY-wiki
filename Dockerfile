...
#RUN mkdir -p /go/src/github.com/aydcyhr/ && cd /go/src/github.com/aydcyhr/ && git clone https://github.com/aydcyhr/ADY-wiki.git && cd ADY-wiki

ADD . /go/src/github.com/aydcyhr/ADY-wiki

WORKDIR /go/src/github.com/aydcyhr/ADY-wiki
...
ADD start.sh /go/src/github.com/aydcyhr/ADY-wiki
...
COPY --from=build /go/src/github.com/aydcyhr/ADY-wiki /ADY-wiki
...
ENV ZONEINFO=/ADY-wiki/lib/time/zoneinfo.zip
